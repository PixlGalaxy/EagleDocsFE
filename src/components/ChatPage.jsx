...
function ChatPage() {
  ...
  // Autoajuste de textarea mejorado
  ...
  // Scroll suave con comportamiento inteligente
  ...
  // Mejor manejo de streaming con buffer
  ...
  // Envío de mensajes con manejo de errores mejorado
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto custom-scrollbar p-4">
          <div className="max-w-3xl mx-auto space-y-6">
            {messages.map((msg, index) => (
              ...
              >
                <div
                  className={`p-4 rounded-xl max-w-[85%] prose dark:prose-invert ${
                    msg.role === 'user'
        ...
        <footer className="border-t border-gray-200 dark:border-gray-700 p-4">
          <div className="max-w-3xl mx-auto flex gap-3">
            <textarea
              ref={textAreaRef}
              className="flex-1 bg-white dark:bg-gray-800 border dark:border-gray-600 rounded-xl p-3
